...
export class SkillsComponent implements OnInit {
  skills:any={
    technologies: [{ name: "JavaScript, Typescript, Angular", percent: 90, remark: 'excellent' },{ name: "HTML 5, CSS 3, Bootstrap", percent: 90, remark: 'excellent' }, { name: "D3js, Nodejs", percent: 70, remark: 'good' }, { name: "Accessiblity", percent: 90, remark: 'excellent' }, { name: ".Net, C#", percent: 60, remark: 'good' }],
